...
public class EdgeCaseTests
{
    ...
    {
        Assert.That(SerializerBlocks.TryGet<FloatOnly>(out var block), Is.True);
        int r = block.Scan(WhitespaceStripper.Strip(".5").AsSpan(), 0, out _);
        Assert.That(r, Is.EqualTo(0));
    }
    ...
    {
        Assert.That(SerializerBlocks.TryGet<FloatOnly>(out var block), Is.True);
        int r = block.Scan(WhitespaceStripper.Strip("1.").AsSpan(), 0, out _);
        Assert.That(r, Is.EqualTo(0));
    }
    ...
    {
        Assert.That(SerializerBlocks.TryGet<UintField>(out var block), Is.True);
        int r = block.Scan(WhitespaceStripper.Strip("x").AsSpan(), 0, out _);
        Assert.That(r, Is.EqualTo(0));
    }
    ...
    {
        Assert.That(SerializerBlocks.TryGet<UintField>(out var block), Is.True);
        int r = block.Scan(WhitespaceStripper.Strip("99999999999").AsSpan(), 0, out _);
        Assert.That(r, Is.EqualTo(0));
    }
    ...
    public void Ulong_NoDigits_ReturnsStart()
    {
        ...
        int r = block.Scan(WhitespaceStripper.Strip("UL").AsSpan(), 0, out _);
        Assert.That(r, Is.EqualTo(0));
    }
    ...
    public void Double_ExponentWithoutDigits_ReturnsStart()
    {
        ...
        int r = block.Scan(WhitespaceStripper.Strip("1.5e").AsSpan(), 0, out _);
        Assert.That(r, Is.EqualTo(0));
    }
    ...
    public void String_Unquoted_Rejected()
    {
        ...
        Assert.That(r, Is.EqualTo(0));  // 裸字符串不再被接受
    }
    ...
    {
        Assert.That(SerializerBlocks.TryGet<StringOnly>(out var block), Is.True);
        int r = block.Scan(WhitespaceStripper.Strip("\"hello world\"").AsSpan(), 0, out StringOnly v);
    ...
    public void Bool_ShortString_ReturnsStart()
    {
        ...
        int r = block.Scan(WhitespaceStripper.Strip("t").AsSpan(), 0, out _);
        Assert.That(r, Is.EqualTo(0));
    }
    ...
    {
        Assert.That(SerializerBlocks.TryGet<FloatOnly>(out var block), Is.True);
        int r = block.Scan(WhitespaceStripper.Strip("3.5  ").AsSpan(), 0, out _);
        Assert.That(r, Is.GreaterThan(0));
    }
    ...
    public void Scan_TabSeparated()
    {
        ...
        int r = block.Scan(WhitespaceStripper.Strip("1.5\t-2").AsSpan(), 0, out _);
        Assert.That(r, Is.EqualTo(0));
    }
}
